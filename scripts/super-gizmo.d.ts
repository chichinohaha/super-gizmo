...
declare abstract class superGizmo extends Editor.Gizmo {
    ...
    abstract onLineTouchMoved(touchStartPoint: cc.Vec2, dx: number, dy: number, event: MouseEvent, drawIndex: number, groupIndex: number, line: Svg.Line): void;
    ...
    abstract onCircleTouchMoved(touchStartPoint: cc.Vec2, dx: number, dy: number, event: MouseEvent, drawIndex: number, groupIndex: number, circle: Svg.Circle): void;
    ...
    abstract onRectTouchMoved(touchStartPoint: cc.Vec2, dx: number, dy: number, event: MouseEvent, drawIndex: number, groupIndex: number, rect: Svg.Rect): void;
    ...
    abstract onPathTouchMoved(touchStartPoint: cc.Vec2, dx: number, dy: number, event: MouseEvent, drawIndex: number, groupIndex: number, path: Svg.Path): void;
